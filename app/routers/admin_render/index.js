...
router.get("/allfaqs", adminRenderMiddleware.checkAuthAdmin, adminRenderController.allfaqs);
router.get("/composeMail", adminRenderMiddleware.checkAuthAdmin, adminRenderController.composeMail);
router.get("/banners", adminRenderMiddleware.checkAuthAdmin, adminRenderController.banners);
router.get("/allbanners", adminRenderMiddleware.checkAuthAdmin, adminRenderController.allbanners);
router.get("/editbanner/:bannerId", adminRenderMiddleware.checkAuthAdmin, adminRenderController.editbanner);
