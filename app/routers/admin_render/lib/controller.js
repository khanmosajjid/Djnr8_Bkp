...
controllers.allfaqs = (req, res) => {
    return res.render('Admin/allfaqs', {
        req: req,
        res: res
    });
}
...
controllers.allbanners = (req, res) => {
    return res.render('Admin/allbanners', {
        req: req,
        res: res
    });
}

controllers.editbanner = (req, res) => {
    log.green(req.params.bannerId);
