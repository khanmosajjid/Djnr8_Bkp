$(document).ready(function () {
    $('#nftTable').DataTable({
        ...
        },
        {
            "mData": "eType",
            render: function (mData, type, row) {
                return `<button onclick="popupNFT($(this))" track-cover="${row.track_cover}" nft-type="${row.eType}" nft-hash="${row.sHash}" data-toggle="modal" data-target="#nftModel" class="btn btn-secondary btn-xs"><i class="fa fa-eye"></i></button>`;
            }
        },
        {
...
function popupNFT(btn) {
    if (btn.attr("nft-type") == "Audio") {
        $("#src").attr("src", "https://ipfs.infura.io/ipfs/" + btn.attr("nft-hash"));
        
        $("#nft-image").attr("src",  btn.attr("track-cover"));
        
        //$("#nftImg").attr("src", + btn.attr("track-cover"));
        audio = new Audio("https://ipfs.infura.io/ipfs/" + btn.attr("nft-hash"));
        document.getElementById("audio").load();

        $("#imageNFTPreview").addClass("d-none");
        $("#audioNFTPreview").removeClass("d-none");
    } else {
        $("#nftImg").attr("src", "https://ipfs.infura.io/ipfs/" + btn.attr("nft-hash"));
